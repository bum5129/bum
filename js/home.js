document.addEventListener('DOMContentLoaded', function() {
  ...
  // DOM 요소
  const findProjectsBtn = getElement('find-projects');
  const findMembersBtn = getElement('find-members');
  const projectsSection = getElement('projects-section');
  const membersSection = getElement('members-section');
  const registerProjectSection = getElement('register-project-section');
  const registerMemberSection = getElement('register-member-section');
  const projectList = document.querySelector('.project-list');
  const memberCategories = document.querySelector('.member-categories');
  const backBtns = document.querySelectorAll('.back-btn');
  const registerProjectBtn = getElement('register-project-btn');
  const registerMemberBtn = getElement('register-member-btn');
  const profileModal = getElement('profile-modal');
  const profileDetails = getElement('profile-details');
  const closeBtn = document.querySelector('.close-btn');
  const searchBar = document.querySelector('.search-bar input');
  const roleTabs = document.querySelectorAll('.role-tab');
  const projectForm = getElement('project-form');
  const memberForm = getElement('member-form');
  const memberRoleSelect = getElement('member-role');
  ...
  function showProfileModal(name, url, role, index) {
    if (!profileModal || !profileDetails) {
